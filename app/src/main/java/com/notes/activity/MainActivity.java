...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean dateSortCheck = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            dateSortCheck = savedInstanceState.getBoolean("sortcheck");
            if (dateSortCheck)
            {
    ...
    public void onSaveInstanceState(@NonNull Bundle outState){
        ...
        if (dateSortCheck)
            outState.putSerializable("sortcheck", true);
        else
            outState.putBoolean("sortcheck", false);
